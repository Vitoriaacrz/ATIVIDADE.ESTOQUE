...
def cadastrar():
    ...
    if (senha == c_senha):
        try:
            banco = sqlite3.connect('Tela-de-login-Python/tela_login/banco_cadastro.db') 
            cursor = banco.cursor()
...
primeira_tela=uic.loadUi("Tela-de-login-Python/tela_login/primeira_tela.ui")
segunda_tela = uic.loadUi("Tela-de-login-Python/tela_login/segunda_tela.ui")
tela_cadastro = uic.loadUi("Tela-de-login-Python/tela_login/tela_cadastro.ui")
